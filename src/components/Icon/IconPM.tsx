    ...
    <svg width={size} height={size} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <linearGradient
          ...
          <stop offset=".5" stopColor="#fcd966"></stop>
        ...
        <linearGradient
          ...
          y1="112.8"
          y2="175.2"
          href="#meteoconsFallingStarsFill1"></linearGradient>
        <linearGradient
        ...
        <clipPath id="meteoconsFallingStarsFill4">
          <path fill="none" d="M512 27.5L240 189.1l16 48l40 32l216-96V27.5z"></path>
        </clipPath>
        <symbol id="meteoconsFallingStarsFill5" viewBox="0 0 270 270">
          <path
            ...
            <animateTransform
              ...
              type="rotate"
              values="-15 135 135; 9 135 135; -15 135 135"></animateTransform>
          </path>
        </symbol>
      </defs>
      <g clipPath="url(#meteoconsFallingStarsFill4)" opacity="0">
        <path
          fill="none"
          stroke="#fcd34d"
          strokeLinecap="round"
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="2"
          d="m329.1 165.3l18 18.3a1.8 1.8 0 0 1 .5 1.8l-6.5 24.9a1.8 1.8 0 0 0 3 1.7l18.4-18a1.8 1.8 0 0 1 1.7-.4l25 6.4a1.8 1.8 0 0 0 1.7-3l-18-18.4a1.8 1.8 0 0 1-.5-1.7l6.4-24.9a1.8 1.8 0 0 0-3-1.7l-18.3 18a1.8 1.8 0 0 1-1.7.4l-25-6.4a1.8 1.8 0 0 0-1.7 3Z"></path>
        <animateTransform
          ...
          repeatCount="indefinite"
          type="translate"
          values="-126 48; 42 -30"></animateTransform>
        <animate
      ...
      <path
        ...
        <animateTransform
          ...
          repeatCount="indefinite"
          type="rotate"
          values="-15 312 144; 15 312 144; -15 312 144"></animateTransform>
        <animate
          attributeName="opacity"
          calcMode="spline"
          dur="6s"
      ...
      <path
        ...
        <animateTransform
          ...
          repeatCount="indefinite"
          type="rotate"
          values="-15 372 222; 15 372 222; -15 372 222"></animateTransform>
        <animate
          attributeName="opacity"
          begin="-.67s"
          calcMode="spline"
      ...
      <use
        ...
        transform="translate(121 121)"></use>
    </svg>
  );
};
